...
```bash
docker build --build-arg TRAINING_HUGO_ENV=puzzle -t acend/tekton-basics-training .
```

Run it locally:

```bash
docker run -i -p 8080:8080 acend/tekton-basics-training
```
