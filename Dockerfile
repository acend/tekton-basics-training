...
LABEL org.opencontainers.image.title "acend.ch's Tekton Basics Training"
LABEL org.opencontainers.image.description "Container with acend.ch's Tekton Basics Training content"
LABEL org.opencontainers.image.authors acend.ch
LABEL org.opencontainers.image.source https://github.com/acend/tekton-basics-training/
